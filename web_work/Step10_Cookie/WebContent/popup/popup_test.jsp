...
<head>
<meta charset="UTF-8">
<title>popup/popup_test.jsp</title>
</head>
<body>
<script>
/*	
...
//팝업을 중앙에 띄우는 함수 
function showPopup2(){
	PopupCenter("popup_page.jsp","팝업창", 400, 400);
}
...
<a href="javascript: showPopup()">팝업 페이지 띄우기</a>
<a href="javascript: showPopup2()">가운데에 팝업띄우기</a>
</body>
</html>
