...
<ul class="pagenation">
	<c:choose>
		...
		<c:otherwise>
			<li class="disabled"><a href="javascript:">[ 이전 ]</a></li>
		</c:otherwise>
	</c:choose>
	...
	<c:forEach var="i" begin="${startPageNum }" end="${endPageNum }">
		<c:choose>
			<c:when test="${i eq pageNum }">
				<li><a  class="active" href="list.do?pageNum=${i }&condition=${condition}&keyword=${keyword}">${i }</a></li>
			</c:when>
			<c:otherwise>
	...
	<c:choose>
		...
		<c:otherwise>
			<li class="disabled"><a href="javascript:">[ 다음 ]</a></li>
		</c:otherwise>
	</c:choose>
	</ul>
	</nav>
