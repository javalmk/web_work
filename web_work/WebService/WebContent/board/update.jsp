...
<%if(isFileSuccess && isBoardSuccess){%>
	location.href="${pageContext.request.contextPath}/board/detail.jsp?num=<%=dto.getNum()%>";
<%}else{ %>
	location.href="${pageContext.request.contextPath}/board/update.jsp?num=<%=dto.getNum()%>";
<%} %>
</script>
</body>
</html>
